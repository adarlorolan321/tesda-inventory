...
<template>
  ...
  <div class="container-xxl bg-logo" style="">
          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center mb-4 mt-2">
              <a href="index.html" class="app-brand-link">
                <img
                  ...
                  alt=""
                />
                <span class="app-brand-text demo text-body fw-bold">Tesda</span>
              </a>
            </div>
            <!-- /Logo -->
            <h4 class="mb-1 pt-2">Welcome to Tesda</h4>
            ...
            >
              ...
              <div class="mb-3 text-center">
                <button class="mb-2 btn btn-primary d-grid w-100" type="submit">
                  Sign in
                </button>
                <p class="mb-0">or</p>
                <inertia-link class="" href="/register"> Sign Up </inertia-link>
              </div>
            </form>
