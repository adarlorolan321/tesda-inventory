            ...
            <div class="form-group mb-4">
              ...
              <div v-else>
                <div class="dropzone" ref="dropzone">
                  <div class="dz-message needsclick">Please Wait</div>
                </div>
              </div>
      ...
      <table class="table">
        <thead class="table-light">
          <tr>
            ...
            <th class="sortable" @click="handleServerQuery('sort', 'role')">
              Role
              <i
                class="ti ti-arrow-up"
                v-if="serverQuery.sort == 'role' && serverQuery.order == 'desc'"
              ></i>
              <i
                class="ti ti-arrow-down"
                v-if="serverQuery.sort == 'role' && serverQuery.order == 'asc'"
              ></i>
            </th>
            <th class="sortable" @click="handleServerQuery('sort', 'email')">
              ...
              <i
                class="ti ti-arrow-up"
                v-if="
                  serverQuery.sort == 'email' && serverQuery.order == 'desc'
                "
              ></i>
              <i
                class="ti ti-arrow-down"
            ...
            <th class="sortable" @click="handleServerQuery('sort', 'phone')">
              ...
              <i
                class="ti ti-arrow-up"
                v-if="
                  serverQuery.sort == 'phone' && serverQuery.order == 'desc'
                "
              ></i>
              <i
                class="ti ti-arrow-down"
                v-if="serverQuery.sort == 'phone' && serverQuery.order == 'asc'"
              ></i>
            </th>
            <th class="sortable" @click="handleServerQuery('sort', 'status')">
              ...
              <i
                class="ti ti-arrow-up"
                v-if="
                  serverQuery.sort == 'status' && serverQuery.order == 'desc'
                "
              ></i>
              <i
                class="ti ti-arrow-down"
                v-if="
                  serverQuery.sort == 'status' && serverQuery.order == 'asc'
                "
              ></i>
            </th>
            <th>Actions</th>
