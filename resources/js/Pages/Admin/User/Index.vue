        ...
        >
          ...
          <div class="offcanvas-body mt-4 mx-0 flex-grow-0">
              ...
              <input
                ...
                @input="
                  ($event) => {
                    ...
                    validateForm(['required'], form, $event.target.value, 'position');
                  }
                "
                placeholder="Enter position"
                :class="{
                  'is-invalid': form.errors.position,
                }"
              />
              <div class="invalid-feedback">
            ...
            <div class="form-group mb-3">
              ...
              >
                <option v-for="i in props.department" :value="i.id">
                  {{ i.name }}
                </option>
              </select>
      ...
      <table class="table">
        <thead class="table-light" style="min-width: 200px">
          <tr>
            ...
            <th style="widh: 150px">Actions</th>
          </tr>
        </thead>
        <tbody class="table-border-bottom-0">
          ...
          <tr v-for="tableData in paginatedData.data" :key="tableData">
            ...
            <td>{{ tableData.department?tableData.department.name:'' }}</td>
