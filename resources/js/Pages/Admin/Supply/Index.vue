...
<template>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offCanvasForm" data-bs-backdrop="static"
                    ...
                    <div class="offcanvas-body mt-4 mx-0 flex-grow-0">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="label" class="form-control" v-model="form.label" @input="
                                ($event) => {
    ...
    'is-invalid': form.errors.label,
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="type" class="form-control" v-model="form.type" @input="
                                ($event) => {
    ...
    'is-invalid': form.errors.type,
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" name="" id="" cols="30" rows="10" placeholder="Enter Description"
                                v-model="form.description" :class="{
        ...
        <div class="table-responsive text-nowrap">
            <table class="table">
                <thead class="table-light" style="min-width: 200px">
                    <tr>
                        <th class="sortable" @click="handleServerQuery('sort', 'label')">
                            Label
                        </th>
                        <th style="min-width: 200px; width: 30%" class="sortable"
                            @click="handleServerQuery('sort', 'type')">
                            Type
                            <i class="ti ti-arrow-up" v-if="
                                serverQuery.sort == 'type' &&
                                serverQuery.order == 'desc'
                            "></i>
                            <i class="ti ti-arrow-down" v-if="
                                serverQuery.sort == 'type' &&
                    ...
                    <tr v-for="tableData in paginatedData.data" :key="tableData">
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                ...
                                <button class="btn btn-icon btn-label-info waves-effect" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal" title="Add Stocks">
                                ...
                                <a class="btn btn-icon btn-label-primary waves-effect" data-bs-toggle="tooltip"
                                    ...
                                    @click="handleEdit(tableData)" href="javascript:void(0);"><i class="ti ti-pencil"></i>
                                </a>
                                <a class="btn btn-icon btn-label-danger waves-effect" data-bs-toggle="tooltip"
                                    data-bs-placement="top" data-bs-custom-class="tooltip-danger" title="Delete"
                                    href="javascript:void(0);" @click="deletePromise(tableData.id)"><i
                                        class="ti ti-trash"></i>
                                </a>
                            </div>
                        </td>
                    ...
                    <nav class="dataTables_paginate paging_simple_numbers" aria-label="Page navigation example">
                        <ul class="pagination mb-0">
                            <li class="page-item" v-for="link in paginatedData.meta.links">
                                <inertia-link class="page-link" :class="{
                                    active: link.active,
