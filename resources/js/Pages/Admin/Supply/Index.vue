              ...
              <input
                ...
                @input="
                  ($event) => {
                    ...
                    validateForm(['required'], form, $event.target.value, 'label');
                  }
                "
              ...
              <input
                ...
                @input="
                  ($event) => {
                    ...
                    validateForm(['required'], form, $event.target.value, 'type');
                  }
                "
          ...
          <tr>
            ...
            >
              ...
              <i
                ...
                v-if="serverQuery.sort == 'type' && serverQuery.order == 'desc'"
              ></i>
              <i
                class="ti ti-arrow-down"
                v-if="serverQuery.sort == 'type' && serverQuery.order == 'asc'"
              ></i>
            </th>
